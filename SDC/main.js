...
const traffic = [
  ...
  new Car(road.getLaneCentre(2), -500, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(0), -700, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(1), -800, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(0), -900, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(2), -1000, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(1), -1000, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(2), -1100, 30, 50, "DUMMY", 2),
  new Car(road.getLaneCentre(0), -1200, 30, 50, "DUMMY", 2),
];
